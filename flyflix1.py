...
def optomotorleft():
    ...
    opening_screen = Trial(
        ...
        openloop_duration=Duration(100000), 
...
@app.route('/optomotorleft/')
def local_optomotor_left():
    _ = socketio.start_background_task(target=optomotorleft)
    return render_template('l4l5left.html')

@app.route('/optomotorright/')
def local_optomotor_right():
    _ = socketio.start_background_task(target=optomotorright)
...
def log_metadata():
    ...
    metadata = {
        ...
        "birth-start": "2023-03-10 18:30:00",
        "birth-end": "2023-03-11 20:00:00",
